...
toggleButton.addEventListener('click', function() {
    ...
    if (currentCSS === 'CSS/Sobih_theme1_CH.css') {
        cssLink.setAttribute('href', 'CSS/Sobih_theme2_CH.css');
    } else {
        cssLink.setAttribute('href', 'CSS/Sobih_theme1_CH.css');
    }
});

//list by subjects search 
  const CH = document.querySelectorAll("#chem");
  CH.forEach( CH => {  
...
function validate2(event) {
    ...
    var inputs = document.querySelectorAll('.name_pass_ch_on2');
    var isEmpty = false;
